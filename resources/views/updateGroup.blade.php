    ...
    <div class="container">
        ...
        <form action="">
            ...
            <div class="d-grid flex">
                <button class="btn btn-danger d-grid" type="submit">Actualizar</button>
                <button class="btn btn-primary d-grid" type="button" onclick="window.location.href='dashboard'">Regresar</button>
            </div>
